...
<img src={images.coinImage} alt='sdfd' className='w-[15px]'/>
        ...
        <p className="pb-6 text-[15px] w-full text-center">
          Perform more activities or buy more {texts.projectSymbol} to stay ahead and claim listing giveaway bonues!😎
        </p>
      </div>
      );
...
<img src={images.coinImage} alt='sdfd' className='w-[70px]'/>
