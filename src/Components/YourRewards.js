          ...
          <div className="w-full rounded-[16px] py-1 flex items-center justify-between space-x-1">
              ...
              <div className='w-fit pr-2'>
                ...
                <span className='flex items-center w-fit text-[15px]'>
                   ...
                   <span className='font-semibold text-primary'>
                     +{formatNumber(checkinRewards)} {texts.projectSymbol}
                   </span>
                 </span>
              ...
              <div className='w-fit pr-2'>
                ...
                <span className='flex items-center w-fit text-[15px]'>
                   ...
                   <span className='font-semibold text-primary'>
                     +{formatNumber(taskPoints)} {texts.projectSymbol}
                   </span>
                 </span>
              ...
              <div className='w-fit pr-2'>
                ...
                <span className='flex items-center w-fit text-[15px]'>
                   ...
                   <span className='font-semibold text-primary'>
                     +{formatNumber(miningTotal)} {texts.projectSymbol}
                   </span>
                 </span>
              ...
              <div className='w-fit pr-2'>
               ...
               Telegram Premium
                ...
                <span className='flex items-center w-fit text-[15px]'>
                   ...
                   <span className='font-semibold text-primary'>
                     +{formatNumber(premiumReward)} {texts.projectSymbol}
                   </span>
                 </span>
