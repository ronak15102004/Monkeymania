...
const Ref = () => {
  ...
  const handleShare = async () => {
    const shareData = {
      title: `Mine ${texts.projectSymbol} tokens now!`,
      // eslint-disable-next-line
      url: `https://t.me/${urls.botUsername}?start=r${id}\n\ `, // Replace with your link
      text: `${texts.projectSymbol} tokens mining is live! Two is better than one!  Join my squad, and let's double the fun (and earnings 🤑)! ${texts.projectName} Power Tap! 🚀`,
    };
